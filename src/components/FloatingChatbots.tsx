...
export default function FloatingChatbots() {
  ...
  const handleUserQuery = (query: string) => {
    ...
    if (norm.includes("who is") || norm.includes("about") || norm.includes("background")) {
      reply = "Neeraj Singh is a Software Engineer, SDET, and Full-Stack Web Developer with 10.5+ years of experience in software quality engineering, test automation, and modern web development. He specializes in Python, Java, Playwright, Selenium, Pytest, TestNG, REST API Automation, and CI/CD, building scalable automation frameworks for Logistics and Supply Chain platforms. Beyond test automation, Neeraj develops modern, responsive, and high-performance web applications using React, Next.js, JavaScript, TypeScript, HTML5, CSS3, Tailwind CSS, Bootstrap, and Node.js. He is passionate about creating premium user experiences, integrating AI-powered features, and delivering secure, scalable, and SEO-friendly applications. His expertise spans automation architecture, web application development, API integration, cloud-ready deployments, DevOps practices, and AI-assisted solutions, enabling organizations to build reliable software with exceptional user experiences.";
    } else if (norm.includes("framework") || norm.includes("explain") || norm.includes("architecture")) {
      reply = "Neeraj Singh architects enterprise-grade, scalable automation frameworks using Python, Playwright, Selenium, Pytest, Java, and TestNG, following best practices like Page Object Model (POM), Hybrid, Data-Driven, and Keyword-Driven architectures. He builds reusable libraries featuring custom utilities, decorators, dynamic wait strategies, self-healing elements, centralized logging, and automatic capture of screenshot/video on failures, integrated with Allure and HTML reports. His suites integrate seamlessly with GitLab CI/CD, Jenkins, Docker, and cloud grids. Beyond automation, he develops full-stack web applications with React, Next.js, TypeScript, and Node.js, building premium, fast, and secure user interfaces.";
